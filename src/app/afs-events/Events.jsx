...
const Events = () => {
    ...
    const getSVG = (isActive) => {
        ...
        if (!isActive) {
            return ` <svg width="36" height="49" viewBox="0 0 36 49" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<image id="image0_10081_11572" width="282" height="67" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
    ...
    return (
        <div>
            <div className='flex items-center lg:flex-row flex-col lg:h-[500px] h-[820px] gap-4'>
                <div className='lg:w-1/3 h-full w-full'>
                    ...
                    <div className='lg:h-[calc(500px-195px)] h-[calc(420px-150px)] overflow-y-scroll popup-scroll-bar-1'>
                        {
                                ...
                                return (
                                    <div onClick={() => handleClick(idKey, event_name, latitude, longitude)} onMouseLeave={() => setShopName("")} onMouseEnter={() => setShopName(event_name)} className={`my-1 ${selectedShop === idKey ? "text-white bg-[#1D98FF]" : "bg-white text-black "}  p-5 h-fit lg:w-[99%] w-full rounded-[4px]`} key={i}>
                                        ...
                                        <div className={`flex items-center gap-2 text-lg py-1 px-2 ${selectedShop === idKey ? "bg-white text-black" : "bg-[#E6E6E6]"} w-fit rounded-2xl mt-3`}>
                                            <Image alt={country} className='w-[20px] h-[14px] object-cover' width={18} height={22} src={flag || ""} />
                                            <p>{country}</p>
                                            <p>{location}</p>
                                        </div>
                                        <div className={`flex items-center gap-2 text-lg py-1 px-2 ${selectedShop === idKey ? "bg-white text-black" : "bg-[#E6E6E6]"} w-fit rounded-2xl mt-3`}>
                ...
                <div className='lg:w-2/3 h-full w-full rounded-[4px] overflow-hidden'>
                    <GoogleMap
                    ...
                    >
                        {
                            locations?.map((loc, i) => {
                                ...
                                console.log(loc?.event_name, selectedShop);
