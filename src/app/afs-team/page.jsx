...
const BreadCums = () => {
    return (
        <div className='uppercase absolute top-6 z-20 global-padding left-6'>
...
const page = () => {
    return (
        <div className='bg-white global-padding relative'>
            <div className='global-padding-top w-full relative global-margin'>
                <BreadCums />
                <h1 className='global-h1 text-center relative mt-0'>L'équipe Foil And Co.</h1>
            </div>
            <div className='flex items-start gap-10 global-margin'>
                <div className='w-[60%] relative'>
                    <Image src={teamImage} alt='Our Team' className='mx-auto rounded-md' />
                </div>
