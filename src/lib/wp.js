...
/**
 * Get WordPress posts from the REST API
 * @param {Object} options - Query options
 * @param {number} options.per_page - Number of posts per page (default: 10, max: 100)
 ...
 * @param {boolean} options.fetchAll - If true, fetches all posts using pagination (default: false)
